    ...
    <section className="px-5 sm:px-10 pb-20 sm:pb-28">
      <div className="max-w-7xl mx-auto rounded-[28px] bg-[#1c1917] px-7 py-10 sm:px-12 sm:py-14 text-[#faf9f5] flex flex-col md:flex-row md:items-end md:justify-between gap-8">
        <div className="max-w-2xl">
          <h2 className="font-editorial text-4xl sm:text-5xl leading-[1.05] tracking-[-0.025em]">Tell us what you need built.</h2>
        </div>
      ...
      <article>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-14 lg:gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="mt-10 sm:mt-12 text-xl sm:text-2xl leading-[1.5] tracking-[-0.02em] text-[#57534e] max-w-2xl">
                Copper Ledger makes Suite and builds custom software for businesses in Nigeria and other countries.
              </p>
        ...
        <section className="border-y border-[#dedbd3] bg-[#f5f2eb] px-5 sm:px-10">
          <div className="max-w-7xl mx-auto grid sm:grid-cols-3">
            ...
            <div className="py-8 sm:py-10 sm:pl-8">
              <p className="font-editorial text-4xl sm:text-5xl tracking-[-0.04em]">Other countries</p>
              <p className="mt-2 text-sm text-[#78716c]">where our software is used</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 sm:px-10 py-20 sm:py-32">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 lg:gap-16">
            <div className="lg:col-span-4">
              <h2 className="font-editorial text-4xl sm:text-5xl leading-[1.08] tracking-[-0.03em]">We build our own products and custom software.</h2>
            </div>
            <div className="lg:col-span-8 grid md:grid-cols-2 border-t md:border-t-0 md:border-l border-[#dedbd3]">
              <div className="pt-8 md:pt-1 md:px-10 pb-10 border-b md:border-b-0 md:border-r border-[#dedbd3]">
                <h3 className="font-editorial text-3xl mb-4">Suite</h3>
                <p className="text-[16px] leading-7 text-[#78716c]">Suite helps stores, schools and hospitals manage stock, people, payments and records.</p>
              ...
              <div className="pt-8 md:pt-1 md:px-10">
                <h3 className="font-editorial text-3xl mb-4">Custom software</h3>
                <p className="text-[16px] leading-7 text-[#78716c]">We build web apps, mobile apps and business systems for the way each business works.</p>
        ...
        <section className="px-5 sm:px-10 pb-20 sm:pb-32">
          <div className="max-w-7xl mx-auto border-t border-[#dedbd3] pt-12 sm:pt-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-7">
              <blockquote className="font-editorial text-4xl sm:text-6xl leading-[1.08] tracking-[-0.035em]">Good software should be clear, reliable and easy to use.</blockquote>
            </div>
            <p className="lg:col-span-4 lg:col-start-9 self-end text-[16px] leading-7 text-[#78716c]">We keep records accurate, make each step easy to follow, and continue improving the software after launch.</p>
          </div>
        </section>
      </article>
      <ContactBand />
...
export function WorkPage() {
  const kinds = [
    ['01', 'Business systems', 'One system for work that has outgrown spreadsheets and separate tools.'],
    ['02', 'Web applications', 'Web apps that staff and customers can use on any modern device.'],
    ['03', 'Mobile applications', 'Mobile apps connected to the same records and processes as the rest of the business.'],
  ];
    ...
    <>
      <article className="px-5 sm:px-10 pt-16 sm:pt-24 pb-24 sm:pb-32">
        <div className="max-w-7xl mx-auto">
          <h1 className="max-w-5xl font-editorial text-[clamp(3.5rem,8vw,7.5rem)] leading-[0.93] tracking-[-0.05em]">Software for running a business.</h1>
          <p className="mt-10 max-w-2xl text-xl sm:text-2xl leading-[1.5] tracking-[-0.02em] text-[#57534e]">Copper Ledger makes Suite and builds custom software for businesses in Nigeria and other countries.</p>
          ...
          <section className="mt-20 sm:mt-28 rounded-[28px] bg-[#1c1917] text-[#faf9f5] overflow-hidden">
            <div className="p-7 sm:p-12 lg:p-16 grid lg:grid-cols-12 gap-12">
              <div className="lg:col-span-7">
                ...
                <p className="mt-7 text-lg sm:text-xl leading-8 text-[#c9c5bd] max-w-2xl">Suite helps stores, schools and hospitals manage their records, payments and daily work in one place.</p>
          ...
          <section className="mt-24 sm:mt-32">
            <div className="grid lg:grid-cols-12 gap-10 mb-12">
              <div className="lg:col-span-5">
                <h2 className="font-editorial text-4xl sm:text-5xl leading-[1.08] tracking-[-0.03em]">Some businesses need software built for them.</h2>
              </div>
              <p className="lg:col-span-5 lg:col-start-8 text-lg leading-8 text-[#78716c] self-end">We build software for your records, staff, customers and daily work.</p>
            </div>
...
export function CapabilitiesPage() {
  const capabilities = [
    ['01', 'Product planning', 'We define the users, records, permissions and steps the software needs.'],
    ['02', 'Web applications', 'Fast, accessible web apps for staff, customers, or both.'],
    ['03', 'Mobile applications', 'Mobile apps connected to the same data as the rest of the business.'],
    ['04', 'Custom business software', 'Systems for stock, payments, people, billing, reports and other daily work.'],
    ['05', 'Support and improvements', 'We can maintain the software, fix problems and add useful features after launch.'],
  ];
  ...
  return (
    <>
      <article className="px-5 sm:px-10 pt-16 sm:pt-24 pb-24 sm:pb-32">
        <div className="max-w-7xl mx-auto">
          <h1 className="max-w-5xl font-editorial text-[clamp(3.5rem,8vw,7.5rem)] leading-[0.93] tracking-[-0.05em]">We design and build complete software products.</h1>
          <div className="mt-10 grid lg:grid-cols-12 gap-8">
            <p className="lg:col-span-7 text-xl sm:text-2xl leading-[1.5] tracking-[-0.02em] text-[#57534e]">We build websites, mobile apps and custom software for businesses.</p>
            <p className="lg:col-span-4 lg:col-start-9 text-[16px] leading-7 text-[#78716c]">We first learn how the work is done. Then we decide what to design and build.</p>
          </div>
          ...
          <section className="mt-24 sm:mt-32 grid lg:grid-cols-12 gap-10 border-t border-[#dedbd3] pt-12 sm:pt-16">
            <div className="lg:col-span-4">
              <h2 className="font-editorial text-4xl sm:text-5xl leading-[1.08] tracking-[-0.03em]">Tell us what is not working.</h2>
            </div>
            <div className="lg:col-span-6 lg:col-start-7 grid sm:grid-cols-2 gap-8 text-[15px] leading-7 text-[#78716c]">
              <p>It may be a task people repeat, a spreadsheet with bad data, missing information, or a product you need.</p>
              <p>We will discuss the problem with you before we decide what to build.</p>
            </div>
          </section>
        </div>
      </article>
  ...
  return (
    <article className="px-5 sm:px-10 pt-16 sm:pt-24 pb-24 sm:pb-32">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-14 lg:gap-20">
        <div className="lg:col-span-5">
          <h1 className="font-editorial text-[clamp(3.75rem,7vw,7rem)] leading-[0.92] tracking-[-0.05em]">What do you need built?</h1>
          <p className="mt-8 text-lg sm:text-xl leading-8 text-[#78716c] max-w-lg">Tell us about your business, the problem, and the software you need.</p>
